...
/* you can see that I'm using a mix of getElementById and getElementsByClassName to retrieve them - as
  ...
  let volSlider = document.getElementsByClassName("vol")[0];
   ...
   /* I've added mute button to the play control */
   let mute = document.getElementsByClassName("muted")[0];

/* I've added another eventlistener to the mute and coded so it can be muted when the button is clicked. There were other many attempts using function to mute and unmute but they all failed and this one finally worked! */
